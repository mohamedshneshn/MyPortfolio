...
const projects = [
  {
    ...
    github: "https://github.com/yourusername/NetMovie",
    live: "https://netmovie.com",
    image: netMovie,
  },
  {
  ...
  },
  {
    ...
    github: "https://github.com/yourusername/SimonGame",
    live: "https://simongame.com",
    image: simonGame,
  },
  {
    ...
    github: "https://github.com/yourusername/ExpensesTracker",
    live: "https://expense-tracker.com",
            ...
            <div key={index} className="col-lg-6 col-md-6 col-12 mb-4">
              ...
              >
                ...
                <div className="relative">
                  ...
                  {/* Icons Overlay */}
                  <motion.div
                    className="absolute inset-0 flex items-center justify-center gap-4 bg-black transition-all duration-300"
                    initial={{ opacity: 0 }}
